...
<div class="row ml-3 mt-4">
        <h1>Tambahan Data Sidik Jari <span id="id">{{$siswa->id}}</span></h1>
  ...
  <div class="row">
    ...
    <div class="col-6">
        ...
        <button class="btn btn-primary " id="tambah_jari" data-id="{{$siswa->id}}">tambahkan sidik jari</button> | 
    ...
    function loadContent() {
        $.ajax({
            ...
            success: function(response) {
                if(response.siswa.sidik_jari !=0){
